...
We created a ts object with one of the series, indispensable to work with JDemetra+ packages

## EStimations

### SA process {.allowframebreaks} 
...
### Only decomposition (a priori not advised)
...
names of output series: see [documentation](https://doc.jdemetra.org/m-x11-decomposition#m-X11-final-output) 
...
# names in JD+_Output_contents.pdf or...
...
sa_x13_v3_ud <- rjd3x13::x13(y_raw, "RSA5c", userdefined = user_defined_output)

# Retrieve the object
# : stored herer, sa_x13_v3_ud$user_defined$
# for instance 
sa_x13_v3_ud$user_defined$residuals.kurtosis # list of objects
```
